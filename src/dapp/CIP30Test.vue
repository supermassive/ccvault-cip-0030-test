<template>
  <div
    class="p-2 bg-blue-700 text-white font-mono font-black flex flex-row flex-nowrap justify-between"
  >
    <span
      ><a href="https://ccvault.io" target="_blank">ccvault.io</a> -
      dapp-connector test page - v1.1.0</span
    >
  </div>
