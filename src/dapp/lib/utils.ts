import { addLogError, addLogSucceeded } from "../useApiLog";
...
export const initialApiFuncs = ["enable", "isEnabled"];

// per wallet namespace
export const initialApiProps = ["apiVersion", "name", "icon"];

export function checkFunctionsExists(
  logId: string,
  obj: any,
  funcList: string[],
): boolean {
...
export function checkPropertiesExists(
  logId: string,
  obj: any,
  propList: string[],
): boolean {
