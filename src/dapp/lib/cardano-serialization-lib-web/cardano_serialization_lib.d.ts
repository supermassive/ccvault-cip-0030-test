...
export interface InitOutput {
  ...
  readonly transactionbody_validity_start_interval: (
    a: number,
    b: number,
  ) => void;
  ...
  readonly transactionbuilder_add_key_input: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly transactionbuilder_add_script_input: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly transactionbuilder_add_bootstrap_input: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly transactionbuilder_set_prefer_pure_change: (
    a: number,
    b: number,
  ) => void;
  readonly transactionbuilder_new: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly transactionbuilder_add_change_if_needed: (
    a: number,
    b: number,
  ) => number;
