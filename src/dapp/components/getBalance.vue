...
import { decodeCborValue, logCoin, logMultiAsset } from "../lib/utilsCbor";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const apiTest: ApiTest = reactive<ApiTest>(
      createApiTest("getBalance", "Check", [
    ...
    async function performCheck() {
      ...
      try {
        ...
        if (!isString(r)) {
          return setApiTestFailed("getBalance: return type not string");
        }
